          ...
          if (!PushAvailability.firebaseReady)
            Material(
              ...
              child: const Padding(
                ...
                child: Text(
                  'Push alerts are not configured on this device. Order updates still appear here when you open the app. Checkout does not depend on push.',
              ...
              error: (error, stackTrace) => Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: hapticize(() => ref.invalidate(myNotificationsProvider)),
